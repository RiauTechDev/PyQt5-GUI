...
# Create database or connect to one that already exist
...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.deleteitem_pushButton_2.setGeometry(QtCore.QRect(180, 50, 141, 31))
		...
		self.clearall_pushButton_3.setGeometry(QtCore.QRect(340, 50, 141, 31))
		...
		self.additem_lineEdit.setGeometry(QtCore.QRect(20, 10, 631, 31))
		self.additem_lineEdit.setObjectName("additem_lineEdit")
		self.mylist_listWidget = QtWidgets.QListWidget(self.centralwidget)
		self.mylist_listWidget.setGeometry(QtCore.QRect(20, 90, 631, 251))
		...
		self.savedb_pushButton.setGeometry(QtCore.QRect(500, 50, 151, 31))
