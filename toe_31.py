...
class UI(QMainWindow):
	def __init__(self):
		...
		# Load the ui file
		uic.loadUi("toe_31.ui", self)

		# Define A Counter To Keep Track Of Who's Turn It Is
		self.counter = 0
		self.statusbar.showMessage('Created By : Christian Yurianja')
	...
	def checkWin(self):
		...
		if self.button7.text() != "" and self.button8.text() == self.button7.text() and self.button9.text() == self.button7.text():
