...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(224, 253)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.red_checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.red_checkBox.setGeometry(QtCore.QRect(70, 20, 59, 29))
        font = QtGui.QFont()
        ...
        self.blue_checkBox.setGeometry(QtCore.QRect(70, 70, 64, 29))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.pushButton.setGeometry(QtCore.QRect(30, 110, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(50, 170, 112, 25))
        font = QtGui.QFont()
        font.setPointSize(16)
